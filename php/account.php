...
<?php
			echo "<center><div><h1>Welcome $login_session</h1></center></div><hr><br>";
			...
			echo "<center>";
			echo "<span><h1> YOUR DETAILS </h1></span><hr><br>";
			$backs='NO';
			if($prow1['backs']!=0)
				$backs='YES';
			if($prow1['pg']!=-1)
			echo " <h1>SSLC: {$prow1['sslc']}% <br> PUC: {$prow1['puc']}% <br> UG: {$prow1['ug']}  <br>PG: {$prow1['pg']} <br> BACKS: $backs <br>EMAIL ID: {$prow1['email']} <br>CONTACT NO: {$prow1['phone']} </h1> ";
			else
			echo "<h1>SSLC: {$prow1['sslc']}% <br> PUC: {$prow1['puc']}% <br> UG: {$prow1['ug']} <br> BACKS: $backs <br>EMAIL ID: {$prow1['email']} <br>CONTACT NO: {$prow1['phone']} </h1>";
			echo "</center>";
