...
$Electrical=mysql_fetch_array($result);  
...
$NonElectrical=mysql_fetch_array($result);  
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <script>
    var Electrical = <?php print $Electrical[0]; ?>;
    var NonElectrical = <?php print $NonElectrical[0]; ?>;
...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#container').highcharts({
            ...
            title: {
                text: 'Placement statistics( Electrical vs Non-Electrical)'
            },
            tooltip: {
