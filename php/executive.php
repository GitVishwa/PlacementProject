...
<br>
 <div class = "table-responsive">
   <caption><h3 align="center">Executive Staff<h3></caption>
   <table class = "table">
       ...
       <tbody>
         <tr>
           <td> <div class="card">
            <div class="photo"><img src="http://localhost/placement/Starter%20Assets/images/pradeep.jpg" alt="..."  class="img-responsive img-circle"></div>
            <div class="banner"></div>
            <ul>
                <li><b>Pradeep Manjunath</b></li>
                <li></li>

            </ul>
            <button class="contact" id="main-button">Placement officer</button>
            ...
            <div class="banner"></div>
            <ul>
                <li><b>Dr.Srinidhi R Acharya</b></li>
                <li></li>
