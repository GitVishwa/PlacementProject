...
<html>
    <head>
        ...
        <script>
    var opendream = <?php print $opendream[0]; ?>;
    var dream = <?php print $dream[0]; ?>;
      var core= <?php print $core[0]; ?>;
      var mass= <?php print $mass[0]; ?>;
     var openmass= <?php print $openmass[0]; ?>;
...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#container').highcharts({
            ...
            title: {
                text: 'Placement statistics in terms of category'
            },
            tooltip: {
