	...
	if(!isset($_POST['register']) || empty($_POST['register']))
		...
		if($testrow['validation']!=2)
			die('INVALID OPERATIONS.');
				...
				$setSql = "SELECT company,name,branch,usn,dob,phone,email,sslc,puc,ug,pg,backs,opendream,dream,core,mass,openmass FROM registrations WHERE company='{$_POST['register']}' GROUP BY usn ORDER BY branch";
